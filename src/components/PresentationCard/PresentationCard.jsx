    ...
    >
      <div className="presentation-card__wrapper">
        <div className="presentation-card__background">
          <span className="presentation-card__title">
            {restaurantMenu.title}
          </span>
          <div className="presentation-card__footer">
            <span className="presentation-card__price">
              {restaurantMenu.priceBucket} • {restaurantMenu.categories}
            </span>
            <span className="presentation-card__time">
